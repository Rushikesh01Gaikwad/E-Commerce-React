...
export default function Viewcards() {
    ...
    const handlePriceFilterChange = (filter) => {
        const updatedFilter = {
            below500: filter === "below500" ? true : false,
            between500And5000: filter === "between500And5000" ? true : false,
            above5000: filter === "above5000" ? true : false,
            showAll: filter === "showAll" ? true : false,
        };
